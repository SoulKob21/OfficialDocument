    ...
    public partial class SaveKP : Form
    {
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                comm.CommandText = @"INSERT INTO acceptdocudemt (DocNo,No_,AcceptDate,From_,To_,Subject_,DocNo_rtn,RecieveDate,Recipient,RecordDate,note,type) 
VALUES (@DocNo,@No,@AcceptDate,@From,@To,@Subject,@DocNo_rtn,@RecieveDate,@Recipient,@RecordDate,@note,@type)";
